...
| `ivSize`            | `number`                         | No       | 16                 | Size of the IV in bytes (usually `16` for AES) Deprecated. Check the [1.3.0](https://github.com/A14313/encryption-utils/blob/main/CHANGELOG.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Encryption only (Deprecated) |
