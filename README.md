...
| `staticKey`         | `string`                         | Yes      | -                  | staticKey is not required if the `password` and `salt` is provided. Static key is used for generating a cipher. <br /> Make sure to generate your **own** key and use `hex` or `base64` encoding when setting this.                                                                                                                                                                                                                                                                                            | Both                         |
